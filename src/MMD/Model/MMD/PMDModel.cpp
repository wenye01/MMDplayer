...
// 文件基于开源项目 https://github.com/itsuhane/libmmd
// 文件基于开源项目 https://github.com/anydream/Pmx2Fbx 
...
namespace mmd
{
    namespace
    {
        ...
        )
        {
            ...
            MMD__WARN("Toon Texture File Not Found. [{}]", texName);
            return "";
        }
    }
    ...
    bool PMDModel::Load(const std::string& filepath, const std::string& mmdDataDir)
    {
        ...
        for (const auto& pmdJoint : pmd.m_joints)
        {
            ...
            {
                MMD__WARN("Illegal Joint [{}]", pmdJoint.m_jointName.ToUtf8String());
            }
        }
